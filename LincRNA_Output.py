...
def write_homepage(outdir,project_name,level,top):
    ...
    html_output+='\n<header><h1 style="font-size:45px;">'+project_name+' Results</h1><h2><img src="../src/logo.png" style="vertical-align: middle;"><br>Ulitsky Lab <br>Weizmann Institute of Science</h2></header>'
